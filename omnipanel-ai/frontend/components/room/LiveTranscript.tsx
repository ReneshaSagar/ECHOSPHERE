        ...
        {entries.map((entry, idx) => {
          ...
          return (
            ...
            >
              ...
              <div className={`max-w-[85%] p-3 rounded-2xl ${entry.speaker === 'candidate' ? 'bg-indigo-600 text-white rounded-tr-sm' : 'bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-slate-100 rounded-tl-sm'}`}>

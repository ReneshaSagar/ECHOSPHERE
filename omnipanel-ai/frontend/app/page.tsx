...
export default function LandingPage() {
  ...
  return (
    <div
      className="relative min-h-screen overflow-hidden bg-[#0B121F] text-slate-100"
    ...
    >
      ...
      <main className="relative z-10 mx-auto flex min-h-screen max-w-[1440px] flex-col px-5 pb-8 pt-24 sm:px-10 lg:px-16">
        <section className="flex min-h-[calc(100vh-10rem)] flex-col justify-between py-8 sm:py-12">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1.12fr_0.88fr] lg:items-end">
            <div className="max-w-4xl">
              ...
              <div className="mt-10 flex flex-wrap items-center gap-3">
                ...
                <a href="#panel" className="inline-flex items-center gap-2 border border-[#00AEEF]/30 bg-[#0B121F]/80 px-5 py-3.5 text-sm font-semibold text-[#00AEEF] backdrop-blur-sm transition-colors hover:border-[#00AEEF] hover:text-white">
                  Meet the panel <ArrowDownRight className="h-4 w-4" />
                </a>
              </div>
            </div>

            <div className="justify-self-end border-l border-[#00AEEF]/25 pl-5 text-sm leading-relaxed text-slate-400 lg:max-w-xs">
          ...
          <div className="mt-16 grid grid-cols-2 gap-px border border-[#00AEEF]/30 bg-[#00AEEF]/30 sm:grid-cols-4">
            {[
              ...
              <div key={label} className="min-h-28 bg-[#0B121F]/90 p-4 backdrop-blur-sm sm:p-5">
                <p className="text-2xl font-semibold tracking-[-0.06em] text-[#00AEEF]">{stat}</p>
                <p className="mt-3 max-w-28 text-[11px] font-medium uppercase leading-relaxed tracking-[0.08em] text-slate-400">{label}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section id="panel" className="border-t border-[#00AEEF]/30 py-16 sm:py-24">
          <div className="mb-10 flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
            <div>
              ...
              <h2 className="mt-3 text-4xl font-semibold tracking-[-0.06em] text-slate-100 sm:text-5xl">Dynamic AI Personas.</h2>
            </div>
            <div className="flex items-center gap-2 text-sm text-slate-400"><Mic className="h-4 w-4 text-[#00AEEF]" /> Live, adaptive voice interviews</div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-px border border-[#00AEEF]/35 bg-[#00AEEF]/35 md:grid-cols-3">
            {[
              ...
              <article key={name} className="group relative min-h-64 overflow-hidden bg-[#0B121F]/95 p-6 backdrop-blur-sm transition-colors hover:bg-slate-900/90 sm:p-8">
                ...
                <h3 className="mt-16 text-3xl font-semibold tracking-[-0.06em] text-slate-100">{name}</h3>
                <p className="mt-2 text-sm text-slate-400">{role}</p>
                <p className="mt-7 max-w-xs text-sm leading-relaxed text-slate-500">
        ...
        <footer className="flex flex-col gap-3 border-t border-[#00AEEF]/25 pt-5 text-[11px] font-semibold uppercase tracking-[0.13em] text-slate-500 sm:flex-row sm:items-center sm:justify-between">

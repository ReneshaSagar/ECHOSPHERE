...
export async function POST() {
  try {
    const defaultDb: Database = {
      ...
      jobs: [
        ...
        },
        {
          ...
          description: 'As a Product Manager for AI Platform at Plantra Labs, you will define the roadmap and developer experience for our core infrastructure products. You will work at the intersection of developer tooling, real-time voice intelligence, and high-scale distributed systems.',
    ...
    return NextResponse.json({ success: true, message: 'JSON Database seeded successfully with Plantra Labs entity and 7 jobs' });
  } catch (error: any) {
